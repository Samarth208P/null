...
/** The supplied product mark, inheriting the surrounding foreground color. */
export function Logo({ size = 24, className = '', ...props }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor"
      xmlns="http://www.w3.org/2000/svg" className={`null-logo ${className}`} aria-hidden="true" {...props}>
